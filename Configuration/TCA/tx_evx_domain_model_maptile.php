...
return [
	...
	'columns' => [
		...
		'x' => [
			'exclude' => true,
			'label' => 'LLL:EXT:evx/Resources/Private/Language/locallang_tca.xlf:tx_evx_domain_model_maptile.x',
			'config' => [
				'type' => 'input',
				'size' => 4,
				'eval' => 'int,required'
		...
		'y' => [
			'exclude' => true,
			'label' => 'LLL:EXT:evx/Resources/Private/Language/locallang_tca.xlf:tx_evx_domain_model_maptile.y',
			'config' => [
				'type' => 'input',
				'size' => 4,
				'eval' => 'int,required'
		...
		'map' => [
			'exclude' => true,
			'label' => 'LLL:EXT:evx/Resources/Private/Language/locallang_tca.xlf:tx_evx_domain_model_maptile.map',
			'config' => [
				'type' => 'group',
				'internal_type' => 'db',
